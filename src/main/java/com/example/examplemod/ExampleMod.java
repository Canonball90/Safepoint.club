...
{
    public static final String MODID = "safepoint";
    public static final String NAME = "Safepoint.club";
    ...
    public static void setSession(Session s) {
        ...
        try {
            ...
            Client.name = " Safepoint.club 1.12.2 | User: " + Minecraft.getMinecraft().getSession().getUsername();
