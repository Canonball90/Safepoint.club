...
public class BlockObject extends Module {
    ...
    public BlockObject(){
        super("BlockObject", Keyboard.KEY_NONE, Category.RENDER);
    }
    ...
    public static void blockESP(BlockPos blockPos) {
        ...
        RenderGlobal.renderFilledBox(new AxisAlignedBB(x, y, z, x + 1.0, y + 1.0, z + 1.0), 66 / 255.0f, 245 / 255.0f, 218 / 255.0f, 100 / 255.0f);
