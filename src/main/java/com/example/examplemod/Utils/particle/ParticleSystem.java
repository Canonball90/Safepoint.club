package com.example.examplemod.Utils.particle;
...
public class ParticleSystem
{
    ...
    public void render() {
        ...
        for (final Particle particle : this.particleList) {
            GL11.glColor4f(10, 20, 200, particle.getAlpha() / 255.0f);
            ...
            this.drawLine(particle.getX(), particle.getY(), nearestParticle.getX(), nearestParticle.getY(), 10, 20, 200, alpha);
        }
        GL11.glPushMatrix();
