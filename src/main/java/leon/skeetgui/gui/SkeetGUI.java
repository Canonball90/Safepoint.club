...
public class SkeetGUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (Module.Category category : Module.Category.values()) {
            ...
            FontUtils.normal.drawString(category.name(),(int)posX + 2, (int)(posY + 20) + offset, new Color(170,170,170).getRGB());
            offset += 50;
        }
        offset = 0;
        for (Module m : Client.getModulesInCategory(selectedCategory)) {
            RenderUtils.drawRect((int) (posX + 65), (int) (posY + 1 + offset), (int) (posX + 125), (int) (posY + 15 + offset),m.toggled ? new Color(55,255,0).getRGB() : new Color(28,28,28).getRGB());
            FontUtils.normal.drawString(m.getName(),(int)posX + 67, (int)(posY + 5) + offset, new Color(170,170,170).getRGB());
            offset += 15;
        }
