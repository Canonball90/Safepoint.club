...
//		GL11.glScalef(0.5f,0.5f, 0.5f);
		Minecraft.getMinecraft().fontRenderer.drawString(binding ? "<PRESS KEY>" : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), parent.parent.getX() + 8, parent.parent.getY() + offset + 2, 0xff777777);
//		GL11.glPopMatrix();
	}
